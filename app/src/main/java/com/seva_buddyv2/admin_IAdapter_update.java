...
public class admin_IAdapter_update extends RecyclerView.Adapter<admin_IAdapter_update.ImageViewHolder> {
    private Context mContext;
    private List<Uploads> mUploads;
    private admin_IAdapter_update.OnItemClickListener mListener;
    Context context;
    public admin_IAdapter_update(Context context, List<Uploads> uploads) {
        mContext = context;
        mUploads = uploads;
    }

    @Override
    public admin_IAdapter_update.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.admin_item, parent, false);
        return new admin_IAdapter_update.ImageViewHolder(v);
    }

    @Override
    public void onBindViewHolder(admin_IAdapter_update.ImageViewHolder holder, int position) {
    ...
    public void setOnItemClickListener(admin_IAdapter_update.OnItemClickListener listener) {
        mListener = listener;
    }
}